...
# arcpy.AddMessage("The passed-down current workspace is: %s" % arcpy.env.workspace) # Its like print
...
# arcpy.env.workspace = r"C:\Data\Course_ArcGIS_Python\Classes\04_arcpy" # more folders should be inside here.
...
arcpy.env.workspace = r"C:\Peck-NRS528_PythonGIS\pythonProject\Classes\04_arcpy\Step_4_data"
