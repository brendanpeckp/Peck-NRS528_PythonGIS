...
# y_coords = "Y"
# z_coords = ""
# out_Layer = "lionfish" # saved in ram (ram will auto delete)
# saved_Layer = r"Step_1_Lionfish_Output.shp" # saved on harddrive
#
...
describe_input = arcpy.Describe(r"Step_1_Deep_Coral.csv")
...
z_coords = ""
out_Layer = "DeepCoral" # saved in ram (ram will auto delete)
saved_Layer = r"Step_1_Deep_Coral_Output.shp" # saved on harddrive
...
spatial_reference_description = arcpy.Describe(lyr).spatialReference.name
print(spatial_reference_description)

##### 4. Visualize the file in ArcPro by dragging it into the program.

print("Yeaaaaahhhh I did it!")
print("I am so happy :)")