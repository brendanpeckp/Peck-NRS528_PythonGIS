...
myWorkspace = r"C:\Peck_NRS528_PythonGIS\pythonProject\Classes\06_cheating\Step_2_data"
arcpy.env.workspace = myWorkspace

for year in listYears:
    arcpy.env.workspace = os.path.join(myWorkspace, "Winter_" + year)
    listOfBands = arcpy.ListRasters()
    listOfBands = listOfBands [:-1]
    print(listOfBands)
