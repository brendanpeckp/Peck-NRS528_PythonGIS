...
# why did the code below not work?: TypeError: print_me() missing 1 required positional argument: 'str'
...
# No, you just need to put an input into the function for the function to act upon.
...
def letter_converter(i, j):
    output = i + j + j + i
    return output
print(letter_converter(i= "a", j= "b"))
print(letter_converter(i= "s", j= "e"))

def letter_converter(i, j):
    output = i + j + j + i
    return output
print(letter_converter("a", "b"))
print(letter_converter("s", "e"))
